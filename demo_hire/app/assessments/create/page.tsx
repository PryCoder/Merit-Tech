        ...
        >
          <Box>
            ...
            <Text mt={2} color="blackAlpha.700" maxW="80ch">
              Configure the job test: tech stack, challenge prompt, mentor
              strictness, and the passing Merit Score threshold.
            </Text>
          </Box>
              ...
              onSubmit={async (e) => {
                ...
                try {
                  const payload = {
                    title,
                    description,
                    revealThreshold: Number.isFinite(Number(revealThreshold))
                      ? Number(revealThreshold)
                      : 70,
                    techStack,
                    mentorStrictness,
                    tasks: [
                  ...
                  const res = await fetchJson<CreateAssessmentResponse>(
                    '/api/assessments',
                    {
                      method: 'POST',
                      body: payload,
            ...
            >
              <FormControl isRequired>
                ...
                <Input
                  ...
                  placeholder="Backend Engineer — Arrays"
                />
              </FormControl>
              ...
              <FormControl>
                ...
                <Textarea
                  ...
                  placeholder="What this role is screening for"
                />
              </FormControl>
              ...
              <FormControl>
                ...
                <CheckboxGroup
                  value={techStack}
                  onChange={(v) => setTechStack(v as string[])}
                >
