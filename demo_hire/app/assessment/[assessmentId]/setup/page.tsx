...
export default function AssessmentSetupPage() {
  ...
  async function start() {
    ...
    try {
      ...
      router.push(`/assessment/${assessmentId}/solve?sessionId=${encodeURIComponent(res.session.id)}`)
    } catch (err) {
  ...
  const canStart = ackRules && ackHonesty && ackSystem
        ...
        <HStack justify="space-between" align="start" spacing={6} flexWrap="wrap">
          <Box>
            ...
            <Text mt={2} color="blackAlpha.700" maxW="70ch">
              Pre-flight checklist. Timer starts only after you click “Start Timer”.
            </Text>
          </Box>
        ...
        <Stack spacing={8}>
          ...
          <Box bg="white" borderRadius="2xl" borderWidth="1px" borderColor="blackAlpha.100" p={{ base: 6, md: 8 }}>
            ...
            <VStack align="stretch" spacing={4}>
              <Checkbox isChecked={ackRules} onChange={(e) => setAckRules(e.target.checked)}>
                I understand the assessment rules and time expectations.
              </Checkbox>
              <Checkbox isChecked={ackHonesty} onChange={(e) => setAckHonesty(e.target.checked)}>
                I will submit my own work.
              </Checkbox>
              <Checkbox isChecked={ackSystem} onChange={(e) => setAckSystem(e.target.checked)}>
          ...
          <Box bg="white" borderRadius="2xl" borderWidth="1px" borderColor="blackAlpha.100" p={{ base: 6, md: 8 }}>
            ...
            <HStack spacing={3} flexWrap="wrap">
              <Badge bg="blackAlpha.50" borderWidth="1px" borderColor="blackAlpha.100" px={3} py={1} borderRadius="full">
                User agent: {typeof navigator !== 'undefined' ? navigator.userAgent.slice(0, 40) + '…' : '—'}
              </Badge>
              <Badge bg="blackAlpha.50" borderWidth="1px" borderColor="blackAlpha.100" px={3} py={1} borderRadius="full">
